...
// Mapeo de colores para Tipos - ACTUALIZADO con todos los tipos de transacción
const TYPE_COLORS: Record<TransactionType, string> = {
  ...
  AJUSTE_MANUAL: 'text-purple-600 bg-purple-50 border-purple-200',
  INGRESO: 'text-blue-600 bg-blue-50 border-blue-200',
