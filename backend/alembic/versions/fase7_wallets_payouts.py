"""
Migración Alembic - Fase 7: Wallets y Pagos Reales

Crea las tablas:
- rider_wallets: Billeteras virtuales de riders
- financial_transactions: Historial inmutable de transacciones
- payout_requests: Solicitudes de retiro bancario

Revision ID: fase7_wallets_payouts
...
revision = 'fase7_wallets_payouts'
down_revision = None  # TODO: Actualizar con la última migración existente
branch_labels = None
depends_on = None
